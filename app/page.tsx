              ...
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://roblox.cd/games/15932212022/your-sus-gas-station-worker?privateServerLinkCode=40121768227366274196932319995146",
                        "_blank",
                      )
                    }
                  >
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://roblox.cd/games/88848566014743/AI-NPC-Friends?privateServerLinkCode=40121768227366274196932319995146",
                        "_blank",
                      )
                    }
                  >
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://roblox.cd/games/126018438287036/Neko-Girl-Town?privateServerLinkCode=40121768227366274196932319995146",
                        "_blank",
                      )
                    }
                  >
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://roblox.cd/games/76106209840076/Weird-Neko-Untitled-Game?privateServerLinkCode=40121768227366274196932319995146",
                        "_blank",
                      )
                    }
                  >
